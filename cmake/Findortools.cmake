# Finds ortools installation From
# https://github.com/google/or-tools/issues/1440#issuecomment-514665531
...
if(WIN32)
  if(NOT TARGET ortools::ortools)
    ...
    set_target_properties(ortools::ortools PROPERTIES IMPORTED_LOCATION
                                                      ${ORTOOLS_LIBRARIES})
    target_include_directories(ortools::ortools
                               INTERFACE ${ORTOOLS_INCLUDE_DIRS})
    ...
    # handle the QUIETLY and REQUIRED arguments and set ortools to TRUE if all
    # listed variables are TRUE
    find_package_handle_standard_args(
      ortools_FOUND REQUIRED_VARS ORTOOLS_LIBRARIES ORTOOLS_INCLUDE_DIRS)
...
elseif(UNIX)
  if(NOT TARGET ortools::ortools)
    ...
    # Libraries changed for ortools >=v8.0
    set(LIB_TO_FIND
        # CbcSolver # CBC_LNK
        # Cbc
        # OsiCbc
    ...
    # Definitions set(ORTOOLS_DEFINITIONS -DUSE_CBC -DUSE_CLP -DUSE_BOP
    # -DUSE_GLOP)
    ...
    # listed variables are TRUE
    find_package_handle_standard_args(
      ortools REQUIRED_VARS ORTOOLS_LIBRARIES ORTOOLS_INCLUDE_DIRS)
  endif()
else()
